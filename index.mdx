...
<CardGroup cols={3}>
  <Card title="GitHub Repository" icon="github" href="https://github.com/soebk/OpenSourceChat402">
    View source code and contribute
  </Card>
  <Card title="Documentation" icon="book" href="https://docs.chat402.xyz">
    Full API docs and guides
  </Card>
  <Card title="Telegram Community" icon="telegram" href="https://t.me/chatx402">
